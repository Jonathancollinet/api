...
HTTP Adok authentication strategie for [Passport](https://github.com/jaredhanson/passport).

This module lets you authenticate HTTP requests using provider(such as facebook/google)+ token + userid scheme in your Node.js applications.  By plugging into Passport, support
for this scheme can be easily and unobtrusively integrated into any
...
The HTTP Adok authentication strategy authenticates users using a userid, a token and a provider.
